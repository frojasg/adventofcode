defmodule Intcode do
  ...
  defp evaluate([99, _], input) do
    input
  end
  defp evaluate([99], input) do
    input
  end
  defp evaluate([1, left, right, out, program], input) do
    a = Enum.at(input, left)
    b = Enun.at(input, right)
    put_in(input, rest, a + b)
    evaluate(program, input)
  end
  defp evaluate(rest, input) do
    input
  end
end
